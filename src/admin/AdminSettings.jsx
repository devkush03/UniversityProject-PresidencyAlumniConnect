...
const AdminSettings = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(system); // You can replace this with actual API POST/PUT
  };
      ...
      {showPasswordPrompt ? (
        <div className="d-flex justify-content-center align-items-center" style={{ height: '100vh', backgroundColor: '#f8f9fa' }}>
          <div className="card p-4 shadow" style={{ width: '400px' }}>
            <h5 className="text-center mb-3">Enter Admin Password</h5>
            <input
              type="password"
          ...
          <div className="card col-lg-12">
            <div className="card-body">
              <form onSubmit={handleSubmit} id="manage-settings">
                ...
                <div className="form-group">
                  {system.cover_img && (
                    <img src={`${baseUrl}${system.cover_img}`} alt="Cover" id="cimg" style={{ maxWidth: '100%', maxHeight: '200px' }} />
                  )}
                </div>
                <center>
