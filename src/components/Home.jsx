...
import { FiUsers, FiImage, FiBriefcase, FiMessageSquare } from 'react-icons/fi';
import { FaCalendar, FaTimes } from 'react-icons/fa';
import { useAuth } from '../AuthContext';
import { useTheme } from '../ThemeContext';
import bgImg from "../assets/uploads/home_bg.jpeg";
...
const Home = () => {
    ...
    return (
        <div>
            ...
            <header className="masthead" style={{ backgroundImage: `url(${bgImg})`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "100vh" }}>
                <div className="container h-100">
                    <div className="row h-100 align-items-center justify-content-center">
                        <div className="col-lg-8  text-center">
                            <h1 className="text-white font-weight-bold display-3 mb-4">Welcome to PRESIDENCY-CSE ALUMNI</h1>
                            <p className="text-white-75 font-weight-light lead mb-5">Connecting CS Alumni of Presidency University Across The Globe</p>
                            {!isAdmin && <Link className="btn btn-primary btn-xl" to="about">Know More</Link>}
            ...
            <section className={`page-section bg-${theme}`} id="alumni-benefits">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h3 className=" card-title text-muted">As a member of the global PU-CSE alumni network, you have access to a variety of exclusive services and benefits.</h3>
                    </div>
                    <div className="row">
                        <div className="col-lg-3 col-sm-6 mb-4">
                            <div className="card h-100 benefit-card">
                                <div className="card-body text-center">
                                    ...
                                    <h4 className="card-title">Alumni Network</h4>
                                    <p className="card-text">Reconnect with graduates, build your network, and grow together professionally.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6 mb-4">
                            <div className="card h-100 benefit-card">
                                <div className="card-body text-center">
                                    <FiImage size={40} className="mb-3 text-primary" />
                                    <h4 className="card-title">Event Gallery</h4>
                                    <p className="card-text">Browse moments from alumni meets, college fests, and special events.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6 mb-4">
                            <div className="card h-100 benefit-card">
                                <div className="card-body text-center">
                                    <FiBriefcase size={40} className="mb-3 text-primary" />
                                    <h4 className="card-title">Career Opportunities</h4>
                                    <p className="card-text">Explore job openings and get referrals from experienced alumni.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6 mb-4">
                            <div className="card h-100 benefit-card">
                                <div className="card-body text-center">
                                    <FiMessageSquare size={40} className="mb-3 text-primary  " />
                                    <h4 className="card-title">Discussion Forums</h4>
                                    <p className="card-text">Engage in conversations, ask questions, and share experiences with the community.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="card-body">
                                    <div className="row align-items-center justify-content-center text-center h-100">
                                        <div className="">
                                            ...
                                            <button className="btn btn-primary read_more" onClick={() => navigate("events/view", { state: { action: "view", data: e } })}>Read More</button>
                                        </div>
                                    </div>
                                </div>
                            </div>))}</> : <>
