...
import forumsMH from "../assets/uploads/forumsMH.jpg";
...
const Forum = () => {
    ...
    const hasPrompted = useRef(false); // Add this at the top inside the component
    ...
    return (
        <>
            <header className="masthead" style={{ backgroundImage: `url(${forumsMH})` }}>
