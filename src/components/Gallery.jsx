...
import galleryMH from "../assets/uploads/galleryMH.jpg";
...
const Gallery = () => {
    ...
    return (
        <>
            <header className="masthead" style={{ backgroundImage: `url(${galleryMH})` }}>
                ...
                <div className="row-items">
                    <div className="col-lg-11 mx-auto">
                        <div className="row">
                            ...
                            {gallery.map((g, index) => (
                                <div className="col-md-4 padzero" key={index}>
