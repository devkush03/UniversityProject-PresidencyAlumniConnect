...
import jobsMH from "../assets/uploads/jobsMH.jpg";
import { useNavigate } from 'react-router-dom';
...
const Careers = () => {
    ...
    return (
        <>
            <header className="masthead" style={{ backgroundImage: `url(${jobsMH})` }}>
                <div className="container-fluid h-100">
                    <div className="row h-100 align-items-center justify-content-center text-center">
                        <div className="col-lg-8 align-self-end mb-4 page-title">
                            <h3 className="text-white">Career Opportunities</h3>
                                        ...
                                        <div className="row  align-items-center justify-content-center text-center h-100">
                                            <div className="">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="filter-txt"><small><b><FaLocationDot />{j.location}</b></small></span>
                                                </div>
                                                <hr />
