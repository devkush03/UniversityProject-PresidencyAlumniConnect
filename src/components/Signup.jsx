...
import homeMH from "../assets/uploads/homeMH.jpg";
...
const Signup = () => {
    ...
    return (
        <>
            ...
            <header className="masthead"style={{ backgroundImage: `url(${homeMH})` }}>
                                ...
                                <div className="container col-lg-6 col-md-8 col-sm-10">
                                    <form onSubmit={handleSubmit} id="create_account">
                                        <div className="form-group">
                                            ...
                                            <input onChange={(e) => setValues({ ...values, name: e.target.value })} type="text" className="form-control" id="name" name="name" placeholder="Your Name" required />
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="email" className="control-label">Email</label>
                                            <input onChange={(e) => setValues({ ...values, email: e.target.value })} type="text" className="form-control" id="email" name="email" required placeholder="examplename.pu@gmail.com"  pattern="^[a-zA-Z0-9._%+-]+\.pu@gmail\.com$"  title="Email must end with .pu@gmail.com" />
                                        </div>
                                        <div className="form-group">
