...
import eventsMH from "../../assets/uploads/eventsMH.jpg";
...
const ViewEvent = () => {
  ...
  const handleParticipation = () => {
    const confirmParticipation = window.confirm("Are you sure you want to participate? This action cannot be undone.");
  ...
  return (
    <>
      <header className="masthead" style={{ backgroundImage: `url(${eventsMH})` }}>
