...
import profileMH from "../assets/uploads/profileMH.jpg";
...
const MyAccount = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                // console.log('alumnus id fetched');

                setAcc({ ...alumnusDetailsRes.data[0], course_id: alumnusDetailsRes.data[0].course_id?.toString() });
                console.log("Courses from backend:", coursesRes.data);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(`${baseUrl}auth/upaccount`, formData, {
                headers: {
    ...
    return (
        <>
            ...
            <header className="masthead" style={{ backgroundImage: `url(${profileMH})` }}>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <form onSubmit={handleSubmit} className="form-horizontal">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-sm-10">
                                        <select onChange={handleChange} className="form-control select2" name="course_id"  value={acc.course_id || " "}>
                                            ...
                                            {courses.map(c => (
                                                <option key={c.id} value={c.id.toString()}>{c.course}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="form-group row">
                                    <label htmlFor="avatar" className="col-sm-2 col-form-label">Profile Image</label>
                                    <div className="col-sm-10">
                                ...
                                <div className="form-group row">
                                    ...
                                    {/* <input onChange={handleChange} type="email" className="form-control" name="email" placeholder="Enter your email" required value={acc.password} /> */}
                                        ...
                                        <small className="form-text text-info fst-italic ">** Leave this field blank if you dont want to change your password **</small>
                                    </div>
                                </div>
